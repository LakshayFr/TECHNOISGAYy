...
# Replace 'YOUR_BOT_API_KEY' with your actual bot API key
BOT_API_KEY = '6978991938:AAHkRIuc3FdRNv58PpLOFbFFBJBYpkdPLG4'
bot = telebot.TeleBot(BOT_API_KEY)

# Replace with your actual user ID for testing
OWNER_ID = 5950631132  # Replace with the owner ID
AUTHORIZED_USER_IDS = [OWNER_ID]  # Add other authorized user IDs to this list
PREMIUM_GROUP_ID = -1002196521096  # Replace with your group ID for sending approved CCs

# Global variables to keep track of the running status for each user
user_tasks = {}
